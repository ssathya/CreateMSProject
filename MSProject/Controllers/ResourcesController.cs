...
namespace MSProject.Controllers
{
    public class ResourcesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Initials,Start,Finish")] Resource resource)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Initials,Start,Finish")] Resource resource)
        {
            if (ModelState.IsValid)
            {
